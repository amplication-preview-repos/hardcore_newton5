...
@InputType()
class InventoryCreateNestedManyWithoutWarehousesInput {
...
export { InventoryCreateNestedManyWithoutWarehousesInput as InventoryCreateNestedManyWithoutWarehousesInput };
